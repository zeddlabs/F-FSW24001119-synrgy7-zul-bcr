class Car extends Component {
  ...
  render() {
    ...
    <div class="card">
      <img
        src="${this.image}"
        class="card-img-top result__car-image"
        alt="..."
      />
      <div class="card-body result__card-body">
        <p class="result__car-name">${this.manufacture} ${this.model}</p>
        <p class="result__car-price">${this.rentPerDay.toLocaleString("id-ID", {
          style: "currency",
          currency: "IDR",
        })} / hari</p>
        <p class="result__car-desc">
          ${this.description}
        </p>
        <ul class="result__car-features">
          <li class="result__car-feature">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
        ...
        <button class="btn btn-success w-100 choose-car__btn">
          Pilih Mobil
        </button>
      </div>
    </div>
